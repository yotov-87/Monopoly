...
namespace Monopoly.Data.Migrations
{
    ...
    [Migration("20251106094325_AddGameTemplates")]
    partial class AddGameTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monopoly.Core.Entities.GameTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Monopoly.Core.Entities.PropertyTrade", b =>
                {
                    b.HasOne("Monopoly.Core.Entities.GamePlayer", "BuyerPlayer")
                        .WithMany()
                    ...
                    b.HasOne("Monopoly.Core.Entities.GamePlayer", "SellerPlayer")
                        .WithMany()
                        .HasForeignKey("SellerPlayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BuyerPlayer");
